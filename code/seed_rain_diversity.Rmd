...
seed_traps <- sampling_station %>% 
  select(bird_sp, mh_id, seeds_m2_mh) %>%
...
#ggsave(here("figs_code/fig_bird_mh_trap_Shannon.pdf"), width = 12, height = 4)
```
